...
//  LoginWithApple
//
//  Created by AbdurRafay on 14/04/2020.
...
class LoginWithApple : NSObject {
    ...
    init (onView view : UIView) {
        ...
        authorizationButton.addTarget(self, action: #selector(handleAuthorizationAppleIDAction), for: .touchUpInside)
        authorizationButton.frame.size = view.frame.size
        authorizationButton.center = view.center
        view.addSubview(authorizationButton)
    }
    
    @objc private func handleAuthorizationAppleIDAction() {
